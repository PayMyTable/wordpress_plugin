...
* A `paymytable` directory that contains the source code - a fully executable WordPress plugin.
...
* `paymytable/includes` is where functionality shared between the admin area and the public-facing parts of the site reside
* `paymytable/admin` is for all admin-specific functionality
* `paymytable/public` is for all public-facing functionality

Note that previous versions of the Boilerplate did not include `PayMyTable_Loader` but this class is used to register all filters and actions with WordPress.
